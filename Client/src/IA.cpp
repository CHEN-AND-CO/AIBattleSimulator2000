...
IA::IA(Game *game, sf::RenderWindow *window, sf::Color color){
  mColor = color;
  mGame = game;
  mWindow = window;
...
bool IA::isTreeFree(const sf::Vector2f pos){
